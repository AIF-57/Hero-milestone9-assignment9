...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className="product my-10 grid grid-cols-2 items-center gap-2 mx-2">
                ...
                <div className="caption mx-8">
                    ...
                    <button className='py-2 px-5 rounded-md bg-slate-700 text-white mt-5 font-semibold'>Reviews</button>
                </div>
            </div>
            <div className="reviewContainer grid grid-cols-3 gap-5 mx-5 mt-20 mb-10">
